...
%% Load signals
trainFilePaths=dir(['trainSignals/*.wav']);
trainSignals=cellfun(@(trainFilePaths) audioread(['trainSignals/', trainFilePaths]), {trainFilePaths.name}, 'UniformOutput', 0);

testFilePaths=dir(['testSignals/*.wav']);
testSignals=cellfun(@(testFilePaths) audioread(['testSignals/', testFilePaths]), {testFilePaths.name}, 'UniformOutput', 0);
