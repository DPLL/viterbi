...
% trainFilePaths=dir('trainSignals.3/*.wav');
% trainSignals=cellfun(@(trainFilePaths) audioread(['trainSignals.3/', trainFilePaths]), {trainFilePaths.name}, 'UniformOutput', 0);
% 
% testFilePaths=dir('testSignals.3/*.wav');
% testSignals=cellfun(@(testFilePaths) audioread(['testSignals.3/', testFilePaths]), {testFilePaths.name}, 'UniformOutput', 0);

trainFilePaths=dir('trainSignals_bak/*.wav');
trainSignals=cellfun(@(trainFilePaths) audioread(['trainSignals_bak/', trainFilePaths])+eps, {trainFilePaths.name}, 'UniformOutput', 0);

testFilePaths=dir('testSignals_bak/*.wav');
testSignals=cellfun(@(testFilePaths) audioread(['testSignals_bak/', testFilePaths])+eps, {testFilePaths.name}, 'UniformOutput', 0);
