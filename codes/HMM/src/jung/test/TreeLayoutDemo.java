...
public class TreeLayoutDemo extends JApplet {
     ...
     * the graph
     */
    //Forest<String,DefaultWeightedEdge> graph;
    DelegateTree<String,DefaultWeightedEdge> graph;
    
/*    Factory<DirectedGraph<String,DefaultWeightedEdge>> graphFactory = 
    	new Factory<DirectedGraph<String,DefaultWeightedEdge>>() {

			public DirectedGraph<String, DefaultWeightedEdge> create() {
				return new DirectedSparseMultigraph<String,DefaultWeightedEdge>();
			}
		};*/
			
/*	Factory<Tree<String,DefaultWeightedEdge>> treeFactory =
		new Factory<Tree<String,DefaultWeightedEdge>> () {

		public Tree<String, DefaultWeightedEdge> create() {
			return new DelegateTree<String,DefaultWeightedEdge>(graphFactory);
		}
	};*/
...
/*    Factory<String> vertexFactory = new Factory<String>() {
    ...
    TreeLayout<String,DefaultWeightedEdge> treeLayout;
    
    RadialTreeLayout<String,DefaultWeightedEdge> radialLayout;
        ...
        radial.addItemListener(new ItemListener() {
			...
			public void itemStateChanged(ItemEvent e) {
				if(e.getStateChange() == ItemEvent.SELECTED) {
					...
					LayoutTransition<String,DefaultWeightedEdge> lt =
						new LayoutTransition<String,DefaultWeightedEdge>(vv, treeLayout, radialLayout);
					...
					LayoutTransition<String,DefaultWeightedEdge> lt =
						new LayoutTransition<String,DefaultWeightedEdge>(vv, radialLayout, treeLayout);
					Animator animator = new Animator(lt);
					animator.start();
					vv.getRenderContext().getMultiLayerTransformer().setToIdentity();
    ...
    private void createTree() {
    	graph.addVertex("V0");
    	graph.addChild(edgeFactory.create(), "V0", "V1");
