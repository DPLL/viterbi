...
x = 8 : 2 : 22;
myObjScore = [ 0.6297070707070704 0.6798111888111884 0.7683044733044732 0.8179494949494948 0.893133838383838 0.9051262626262627 0.9377435897435898 0.9652670940170941 ];
sensorObjScore = [ 0.40578282828282836 0.5432171717171717 0.6415836940836941 0.7285353535353534 0.7929715007215005 0.8459343434343433 0.8895061605061599 0.9332060994560991 ];
myStateScore = [0.7049924242424246 0.7708581973581972 0.8295328282828284 0.863949494949495 0.9319783549783548 0.9367878787878787  0.9553034188034192 0.9794494949494948 ];
plot(x, myObjScore, '-b', 'LineWidth', 7);
hold on;
plot(x, sensorObjScore, '*r-', 'LineWidth', 7)
hold on;
...
ylabel('fidelity', 'FontSize', 18);
title('Effect of dimension (avgDegree=2, objPerNode=3, nodeNum=30, range=100, mean=0, stdDev=20)', 'FontSize', 18);
